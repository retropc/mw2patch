...
type
  ...
  private
    ...
    procedure LoadValues2(AStream: TStream);
  public
    constructor Create(const FileName: string); overload;
    constructor Create(const FileStream: TStream); overload;
    destructor Destroy; override;
    procedure Clear;
...
procedure TMemIniFile.LoadValues2(AStream: TStream);
var
  List: TStringList;
begin
...
constructor TMemIniFile.Create(const FileStream: TStream);
begin
  inherited Create('');
  FSections := THashedStringList.Create;

  LoadValues2(FileStream);
end;
